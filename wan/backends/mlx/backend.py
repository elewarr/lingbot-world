...
from ..base import Backend, mx_to_torch, register_backend, torch_to_mx
...
class MLXBackend(Backend):
    ...
    - Compiled forward pass for kernel fusion
    """
    ...
    def load_model(
        ...
        from ..mlx.quantize import load_quantized_model, quantize_model
